...
final class JSite extends JApplication
{
	...
	public function dispatch($component = null)
	{
		...
		try
		{
			...
			{
				$document->setGenerator('Joomla! - Open Source Content Management jagl  - Version ' . JVERSION);
			}
			else
			{
				$document->setGenerator('Joomla! - Open Source Content Management else jagl');
			}
